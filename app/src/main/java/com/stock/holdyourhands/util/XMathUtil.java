...
public class XMathUtil {
     ...
     * @return 两个参数的积(String)
     */
    public static String multiply(Object v1, Object v2) {
        if (v1.equals(Float.NaN) || v2.equals(Float.NaN)) {
            return "0";
        }
    ...
    public static String divide(Object v1, Object v2) {
        return divide(String.valueOf(v1), String.valueOf(v2), DEF_DIV_SCALE);
    }
     ...
     * @return 两个参数的商(String)
     */
    public static String divide(Object v1, Object v2, Integer scale) {
        return divide(String.valueOf(v1), String.valueOf(v2), scale);
    }
    ...
    public static String divide(String v1, String v2, Integer scale) {
        ...
        if ("0".equals(v1) || "0".equals(v2) || Float.parseFloat(v1) == 0 || Float.parseFloat(v2) == 0) {
            return "0";
        }
